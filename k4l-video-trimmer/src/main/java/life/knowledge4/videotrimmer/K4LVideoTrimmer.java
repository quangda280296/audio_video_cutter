...
public class K4LVideoTrimmer extends FrameLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.view_time_line,
                this, true);
    ...
    public void initThumbs(List<Thumb> listThumb) {
        mRangeSeekBarView.setThumbs(listThumb);
        setUpListeners();
        setUpMargins();
    }
    ...
    private void setUpMargins() {
        ...
        RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams)
                mHolderTopView.getLayoutParams();
    ...
    private void onSaveClicked() {
        if (mStartPosition <= 0 && mEndPosition >= mDuration) {
            ...
            long METADATA_KEY_DURATION = Long.parseLong(mediaMetadataRetriever
            ...
            BackgroundExecutor.execute(
                    new BackgroundExecutor.Task("", 0L, "") {
                        ...
                        public void execute() {
                            try {
                                TrimVideoUtils.startTrim(file, getDestinationPath(getContext()),
                                        mStartPosition, mEndPosition, mOnTrimVideoListener);
    ...
    public static String getDestinationPath(Context context) {
        if (mFinalPath == null) {
            File folder = new File(Environment.getExternalStorageDirectory()
                    + File.separator +"Mp3 Cutter/Video/");
            if (!folder.exists()) {
                folder.mkdirs();
            }
            mFinalPath = folder.getPath();
    ...
    private void setTimeFrames() {
        ...
        mTextTimeFrame.setText(
                String.format("%s %s - %s %s", "Start : ", stringForTime(mStartPosition),
                        "End : ", stringForTime(mEndPosition)));
    }
    ...
    public void setVideoURI(final Uri videoURI) {
        ...
        if (mOriginSizeFile == 0) {
            ...
            if (fileSizeInKB > 1000) {
                ...
                mTextSize.setText(String.format("%s %s", "Size : " + fileSizeInMB, getContext().getString(R.string.megabyte)));
            } else {
                mTextSize.setText(String.format("%s %s", "Size : " + fileSizeInKB, getContext().getString(R.string.kilobyte)));
            }
        }
