package com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.utils;
...
public class StorageUtil {
    ...
    private static File getExternalCacheDirManual(Context context) {
        ...
        File appCacheDir = new File(dataDir,
                context.getString(R.string.app_name));
        if (!appCacheDir.exists()) {
            ...
            try {
                ...
                Log.i(TAG, "Can't create \".nomedia\"" +
                        " file in application external cache directory");
            }
        }
        return appCacheDir;
    }
