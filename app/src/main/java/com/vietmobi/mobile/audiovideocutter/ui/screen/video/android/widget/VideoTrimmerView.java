package com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.widget;
...
import com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.features.trim.VideoTrimmerAdapter;
import com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.features.trim.VideoTrimmerUtil;
import com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.interfaces.IVideoTrimmerView;
import com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.interfaces.VideoTrimListener;
import com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.utils.StorageUtil;
...
import static com.vietmobi.mobile.audiovideocutter.ui.screen.video.android.features.trim.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
    ...
    private void init(Context context) {
        ...
        edtStart = findViewById(R.id.starttext);
        edtEnd = findViewById(R.id.endtext);
        setUpListeners();
    ...
    private void initRangeSeekBarView() {
        ...
        mThumbsTotalCount = 10;

        mVideoThumbRecyclerView.addItemDecoration(
                new SpacesItemDecoration2(VideoTrimmerUtil.RECYCLER_VIEW_PADDING, mThumbsTotalCount));
        ...
        edtStart.setText(DateUtil.convertSecondsToTime(mRangeSeekBarView.mStartPosition));
        edtEnd.setText(DateUtil.convertSecondsToTime(mRangeSeekBarView.mEndPosition));
    }
    ...
    public void initVideoByURI(final Uri videoURI) {
      ...
      /*  mVideoShootTipTv.setText(String.format(mContext.getResources()
                .getString(R.string.video_shoot_tip), VideoTrimmerUtil.VIDEO_MAX_TIME));*/
    }
    ...
    private void setUpListeners() {
        findViewById(R.id.image_back).setOnClickListener(view -> onCancelClicked());
    ...
    private void onSaveClicked() {
        if (mRightProgressPos - mLeftProgressPos < VideoTrimmerUtil.MIN_SHOOT_DURATION) {
            Toast.makeText(mContext, "The video is less than 3 seconds long and cannot be uploaded.",
    ...
    private final RangeSeekBarView.OnRangeSeekBarChangeListener mOnRangeSeekBarChangeListener = new RangeSeekBarView.OnRangeSeekBarChangeListener() {
        ...
        public void onRangeSeekBarValuesChanged(RangeSeekBarView bar, long minValue, long maxValue, int action, boolean isMin,
            ...
            edtStart.setText(DateUtil.convertSecondsToTime(mLeftProgressPos / 1000));
            edtEnd.setText(DateUtil.convertSecondsToTime(mRightProgressPos / 1000));
