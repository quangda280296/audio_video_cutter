...
public class SoundFile {
    ...
    private ShortBuffer mDecodedSamples;  // Raw audio data
    ...
    @SuppressLint("NewApi")
    public static void saveMusic(Context context, File mInputFile,
        ...
        String parentDir = externalRootDir + "audio/";
        File parentDirFile = new File(parentDir);
        parentDirFile.mkdirs();
        if (!parentDirFile.isDirectory()) {
            parentDir = externalRootDir;
        }
        File outFile = new File(parentDir + mInputFile.getName());
        FileOutputStream outputStream = null;
        try {
            if (!outFile.exists()) {
                outFile.createNewFile();
            }
            byte[] data = new byte[(int) mInputFile.length()];
    ...
    private void DumpSamples(String fileName) {
        ...
        String parentDir = externalRootDir + "media/audio/";
