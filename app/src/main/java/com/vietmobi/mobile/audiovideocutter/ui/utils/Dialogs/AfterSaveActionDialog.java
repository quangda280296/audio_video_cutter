...
package com.vietmobi.mobile.audiovideocutter.ui.utils.Dialogs;
...
public class AfterSaveActionDialog extends Dialog {
    ...
    public AfterSaveActionDialog(Context context, OnClickDialogListener onClickDialogListener) {
        super(context);
